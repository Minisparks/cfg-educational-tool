# Educational Tool for Context-Free Grammar Derivations
Created as part of my final year university project 2025-26.

# Functionality
This project provides insight on multiple aspects of CFGs, packaging them up into interactive topics/lessons in which the user can provide strings to be derived.
The user will be guided step-by-step through the derivation at their own pace, then provided with tailored information based on the result.
